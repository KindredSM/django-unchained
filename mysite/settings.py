...
SECRET_KEY = config('SECRET_KEY', default='aopskdfopakodfkaeopf]')
...
# Airtable OAuth settings
AIRTABLE_CLIENT_ID = config('AIRTABLE_CLIENT_ID')
AIRTABLE_CLIENT_SECRET = config('AIRTABLE_CLIENT_SECRET')
AIRTABLE_REDIRECT_URI = config('AIRTABLE_REDIRECT_URI')
